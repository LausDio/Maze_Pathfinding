...
public class PriorityQueue
{
    ...
    public List<Node1> priority = new List<Node1>();
    ...
    public void add(Node1 Neighbour)
    {
      

        List<Node1> ref_ = priority;
    ...
    public List<Node1> getAllValues()
    {
    ...
    public bool Contains(Node1 value) 
    {
