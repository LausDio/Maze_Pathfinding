...
public class grid : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Grid = new Node1[NodeNumberX, NodeNumberY];
        ...
        for (int x = 0; x < NodeNumberX; x++)
        {
            for (int y = 0; y < NodeNumberY; y++)
            {
                ...
                Grid[x, y] = new Node1(nodePos, isWalkable);
    ...
    public Node1 getNodeposition(Vector3 currentNode)
    {
    ...
    private bool isUnwalkable(Node1[,] getNode, Vector3 getPosition)
    {
    ...
    public List<Node1> Neighbours(Node1 currentNode)
    {
        List<Node1> Direction = new List<Node1>();
        ...
        for (int i = 0; i < neighbours.Length; i++)
        {
            ...
            {
                Direction.Add(new Node1(neighbours[i], isUnwalkable(Grid, neighbours[i])));
            }
        }
    ...
    private Vector3[] neighbourArray(Node1 current)
    {
    ...
    void OnDrawGizmos()
    {
        ...
        if (Grid != null)
        {
            ...
            List<Node1> getNodePos = new List<Node1>();
